...
Canonical location: application/knowledge/knowledge_unit_pipeline.py
Do not add new logic here; import from the canonical path in new code.
"""
from importlib import import_module as _import_module
import sys as _sys

_canonical = _import_module("personal_knowledge.application.knowledge.knowledge_unit_pipeline")
